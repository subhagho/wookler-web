    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.wookler.amazon.client.jax.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.wookler.amazon.client.jax.AWSECommerceService.class.getResource(".");
